...
def mapping(fapath, inputpath, outputpath):
...
if __name__ == "__main__":
    ...
    inputpath = r'/data/biolab-nvme-pool1/lijy/sim_readuntil_fastq/CNNLSTMselnet_sustag384_t0.20finetuned_0_5m/'

    # output .paf files path
    outputpath = r'/data/biolab-nvme-pool1/lijy/sim_readuntil_paf/CNNLSTMselnet_sustag384_t0.20finetuned_0_5m/'
    os.makedirs(outputpath, exist_ok=True)


    mapping(fapath, inputpath, outputpath)